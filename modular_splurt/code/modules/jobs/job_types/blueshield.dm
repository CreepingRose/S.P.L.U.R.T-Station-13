...
/datum/outfit/job/blueshield
	...
	backpack_contents = list(/obj/item/storage/firstaid/regular, /obj/item/choice_beacon/bsbaton, /obj/item/reagent_containers/spray/pepper, /obj/item/clothing/accessory/badge/holo)
